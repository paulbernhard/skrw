...
ActiveRecord::Schema.define(version: 2019_01_19_153657) do
  ...
  create_table "skrw_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_skrw_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_skrw_users_on_reset_password_token", unique: true
  end
